...
<body>
 <div class="navbar navbar-inverse navbar-fixed-top">
  <!--*****Header******-->
      ...
      <div class="navbar-inner" style="height: 80px; margin-top:20px; margin-left:90px; width: 90%; border-radius: 14px; background-color: red;">
        ...
        <span class="icon-bar"></span>
          ...
          <a class="brand" href="#" style="font-family: 'Zen Dots', cursive;"><b>MediMart Pharmacy</b></a>
           <div class="nav-collapse" style="text-transform: uppercase; font-family: 'Ubuntu', sans-serif;">
 ...
 <div class="container" style="width: 80%;">
  ...
  <div class="container" style="width:82%; font-family: 'Poppins', sans-serif;">
    <div class="row">
      <table class="table table-bordered table-striped table-hover" id="resultTable" data-responsive="table" styl;e="border-radius: px;">
  
        <thead style="height: 50px; ">
        <tr style="background-color: #383838; color: #FFFFFF; margin-top: -30px;" >
            <th> Medicine </th>
            <th> Category</th>
